...
PYBIND11_MODULE(optimization, m) {
    ...
    py::class_<OptimizationProblem, PyOptimizationProblem>(m, "OptimizationProblem")
        .def(py::init<const unsigned int>(),
            py::arg("dimension"))
        .def("get_dimension", &OptimizationProblem::get_dimension);
    ...
    py::class_<LinearRegressionProblem, OptimizationProblem>(m, "LinearRegressionProblem")
        ...
        .def("compute_yhat", &LinearRegressionProblem::compute_yhat, py::arg("theta"))
    ...
    py::class_<GradientDescent<QuadraticOptimizationProblem>>(m, "GradientDescentQuadraticOptimization")
        .def(py::init<const QuadraticOptimizationProblem&>(), py::arg("QuadraticOptimizationProblem"))
        .def("set_learningRateQuadraticOptimizationProblem", &GradientDescent<QuadraticOptimizationProblem>::set_learningRate, py::arg("learningRate"))
        .def("set_maxIterationsQuadraticOptimizationProblem", &GradientDescent<QuadraticOptimizationProblem>::set_maxIterations, py::arg("iterations"))
        .def("set_convergenceThresholdQuadraticOptimizationProblem", &GradientDescent<QuadraticOptimizationProblem>::set_convergenceThreshold, py::arg("convergenceThreshold"))
        .def("optimizeQuadraticOptimizationProblem", &GradientDescent<QuadraticOptimizationProblem>::optimize, py::arg("problem"))
        .def("get_solutionsQuadraticOptimizationProblem", &GradientDescent<QuadraticOptimizationProblem>::get_solutions);
}